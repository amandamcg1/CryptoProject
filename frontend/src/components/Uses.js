import { Accordion, AccordionDetails, AccordionSummary, Box, ThemeProvider, Typography } from '@mui/material'
...
export default function Uses() {
  return (
    ...
    <ThemeProvider theme={theme}>
      <Box sx={{ backgroundColor: 'secondary.main', p: 3, borderRadius : 4 }} >
        <Typography fontSize={17} mb={2} sx={{ color: 'white', fontWeight: 700 }}>Some of the uses of asymmetric cryptography include:</Typography>
